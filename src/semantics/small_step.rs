...
impl Expression {
    ...
    pub fn is_number(&self) -> bool {
        match self {
            Expression::Number { value: _ } => true,
            _ => false
        }
    }

    pub fn reduce(&self, environment: &HashMap<&'static str, i32>) -> Expression {
        match self {
...
pub fn variable(name: &'static str) -> Expression {
    Expression::Variable { name }
}
